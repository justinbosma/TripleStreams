...
logger = getLogger("helpers/CompGenVAE/modelLoader.py")
logger.setLevel("DEBUG")


def load_GenreVAE_model(model_path, params_dict=None, is_evaluating=True, device=None):
    """ Load a ComplexityGenreVAE model from a given path
...
if __name__ == "__main__":
    ...
    model_ = GenreVAE(config)

    model_.save(save_path="misc/genreVAETest.pth")

    # m_loded

    load_GenreVAE_model("misc/genreVAETest.pth")