...
logger = getLogger("helpers.GenreGlobalDensityWithVoiceMutesVAE.eval_utils")
logger.setLevel("DEBUG")
from data import Groove2Drum2BarDataset

def generate_umap_for_vae_model_wandb(
        model, predict_using_batch_data, dataset_setting_json_path, subset_name,
    ...
    assert isinstance(model, GenreGlobalDensityWithVoiceMutesVAE)
