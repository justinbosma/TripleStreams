...
def load_GenreGlobalDensityWithVoiceMutesVAE_model(model_path, params_dict=None, is_evaluating=True, device=None):
    ...
    model = GenreGlobalDensityWithVoiceMutesVAE(params_dict)
...
if __name__ == "__main__":
    ...
    model_ = GenreGlobalDensityWithVoiceMutesVAE(config)
    model_.save(save_path="misc/genreDensityTempoVAE.pth")
    load_GenreGlobalDensityWithVoiceMutesVAE_model("misc/genreDensityTempoVAE.pth")
