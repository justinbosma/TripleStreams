...
def load_GenreDensityTempoVAE_model(model_path, params_dict=None, is_evaluating=True, device=None):
    """ Load a GenreDensityTempoVAE model from a given path
    ...
    model = GenreDensityTempoVAE(params_dict)
...
if __name__ == "__main__":
    ...
    model_ = GenreDensityTempoVAE(config)
    model_.save(save_path="misc/genreDensityTempoVAE.pth")
    load_GenreDensityTempoVAE_model("misc/genreDensityTempoVAE.pth")
