...
def load_GenreWithVoiceMutesMultiTaskVAEMultiTask_model(model_path, params_dict=None, is_evaluating=True, device=None):
    ...
    model = GenreWithVoiceMutesMultiTaskVAE(params_dict)
...
if __name__ == "__main__":
    ...
    model_ = GenreWithVoiceMutesMultiTaskVAE(config)
    model_.save(save_path="misc/genreDensityTempoVAE.pth")
    load_GenreWithVoiceMutesMultiTaskVAE_model("misc/genreDensityTempoVAE.pth")
