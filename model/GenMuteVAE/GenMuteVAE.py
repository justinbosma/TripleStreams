...
from model import GenreWithVoiceMutesVAEComponents


class GenreWithVoiceMutesVAE(torch.nn.Module):
    """
    ...
    def __init__(self, config):
        ...
        super(GenreWithVoiceMutesVAE, self).__init__()
        ...
        # ---------------------------------------------------
        self.InputLayerEncoder = GenreWithVoiceMutesVAEComponents.InputGrooveLayer(
        ...
        self.Encoder = GenreWithVoiceMutesVAEComponents.Encoder(
            d_model=self.config['d_model_enc'],
        ...
        self.latentLayer = GenreWithVoiceMutesVAEComponents.LatentLayer(
            max_len=self.config['max_len_enc'],
            d_model=self.config['d_model_enc'],
            latent_dim=self.config['latent_dim']
        )

        self.DecoderInput = GenreWithVoiceMutesVAEComponents.DecoderInput(
        ...
        self.Decoder = GenreWithVoiceMutesVAEComponents.Encoder(
            d_model=self.config['d_model_dec'],
        ...
        self.OutputLayer = GenreWithVoiceMutesVAEComponents.OutputLayer(
    ...
    def init_weights(self, initrange):
        ...
        self.DecoderInput.init_weights(initrange)
        self.OutputLayer.init_weights(initrange)
...
if __name__ == "__main__":
    ...
    model = GenreWithVoiceMutesVAE(config)
